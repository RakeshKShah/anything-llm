...
TEST_ID="validation_error_missing_client_secret"
...
{"clientId":"client-only-123","authType":"common"}
JSON

# Given
echo "STEP: Given — prepare request payload missing clientSecret"
echo "PREREQ: using authenticated admin request header for validation path"

# When
echo "STEP: When — POST Outlook auth-url without clientSecret"
...
# Then
echo "STEP: Then — assert 400 validation error for missing clientSecret"
...
echo "CODEVALID_TEST_ASSERTION_OK:validation_error_missing_client_secret"
