...
TEST_ID="happy_path_common_auth_generates_auth_url"
...
{"clientId":"test-client-abc123","clientSecret":"secret-xyz789","authType":"common"}
JSON

# Given
echo "STEP: Given — prepare valid common-auth request payload"
echo "PREREQ: using authenticated admin request header for single-user mode endpoint"

# When
echo "STEP: When — POST Outlook auth-url with common authType"
...
# Then
echo "STEP: Then — assert 200 success and auth URL returned"
...
echo "CODEVALID_TEST_ASSERTION_OK:happy_path_common_auth_generates_auth_url"
